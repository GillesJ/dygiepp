...
experiment_name="ace05-event-alloptions"
data_root="./data/ace-event/processed-data/alloptions/json"
config_file="./training_config/ace05_event_alloptions.jsonnet"
cuda_device=$1
